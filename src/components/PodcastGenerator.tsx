      ...
      {!isGenerating ? (
        <>
          <div className="text-center mb-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Generate Your Detailed Podcast</h2>
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 disabled:from-gray-300 disabled:to-gray-300 disabled:cursor-not-allowed text-white font-bold py-4 px-6 rounded-lg transition-all transform hover:scale-105 disabled:hover:scale-100 flex items-center justify-center space-x-2"
            >
        ...
        <>
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Creating Your Enhanced Podcast</h2>
            <p className="text-gray-600">Researching stories and generating detailed content...</p>
          </div>
          ...
          <div className="text-center">
            <p className="text-gray-700 font-medium mb-2">{currentStep}</p>
            {progress < 70 && (
